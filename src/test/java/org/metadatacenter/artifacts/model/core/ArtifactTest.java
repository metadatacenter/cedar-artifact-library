...
public class ArtifactTest {
  ...
  public void testGetJsonLdId() {
    ...
    Artifact artifact = new Artifact(Optional.of(jsonLdId), Collections.emptyMap(),
  ...
  public void testGetJsonLdContext() {
    ...
    Artifact artifact = new Artifact(Optional.empty(), jsonLdContext,
      Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty());
  ...
  public void testGetCreatedBy() {
    ...
    Artifact artifact = new Artifact(Optional.empty(), Collections.emptyMap(),
