package org.metadatacenter.artifact.redcap;
...
public class REDCapConstants
{
  ...
  public static final String DATE_MD_TEXTFIELD_VALIDATION = "MD";
  public static final String DATE_DY_TEXTFIELD_VALIDATION = "DY";
  public static final String DATE_MY_TEXTFIELD_VALIDATION = "MY";

  public static final String DATETIME_YMD_TEXTFIELD_VALIDATION = "DATETIME_YMD";
  public static final String DATETIME_MDY_TEXTFIELD_VALIDATION = "DATETIME_MDY";
  ...
  public static final Set<String> TEXTFIELD_VALIDATIONS = new HashSet<>(Arrays
    .asList(DATE_YMD_TEXTFIELD_VALIDATION, DATE_MDY_TEXTFIELD_VALIDATION, DATE_DMY_TEXTFIELD_VALIDATION,
      TIME_TEXTFIELD_VALIDATION, DATETIME_YMD_TEXTFIELD_VALIDATION, DATETIME_MDY_TEXTFIELD_VALIDATION,
      DATETIME_DMY_TEXTFIELD_VALIDATION, DATETIME_SECONDS_Y_TEXTFIELD_VALIDATION, DATE_MD_TEXTFIELD_VALIDATION,
      DATETIME_SECONDS_M_TEXTFIELD_VALIDATION, DATE_DY_TEXTFIELD_VALIDATION, DATETIME_SECONDS_D_TEXTFIELD_VALIDATION,
      DATE_MY_TEXTFIELD_VALIDATION, TIME_MM_SS_TEXTFIELD_VALIDATION, PHONE_TEXTFIELD_VALIDATION,
