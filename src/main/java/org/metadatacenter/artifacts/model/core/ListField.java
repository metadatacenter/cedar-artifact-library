...
{
  @Override ListField withExtensions(SchemaExtensions extensions);

  static ListField create(LinkedHashMap<String, URI> jsonLdContext, List<URI> jsonLdTypes, Optional<URI> jsonLdId,
      ...
      implements LiteralDefaultableFieldBuilder
  {
    ...
    public ListFieldBuilder(ListField listField)
    {
      ...
      this.valueConstraintsBuilder = listField.valueConstraints()
...
record ListFieldRecord(LinkedHashMap<String, URI> jsonLdContext, List<URI> jsonLdTypes, Optional<URI> jsonLdId,
                       ...
                       String internalName, String internalDescription, SchemaExtensions extensions) implements ListField
{
  public ListFieldRecord(LinkedHashMap<String, URI> jsonLdContext, List<URI> jsonLdTypes, Optional<URI> jsonLdId,
                       String name, String description, Optional<String> identifier, Optional<Version> version,
                       Optional<Status> status, Optional<URI> previousVersion, Optional<URI> derivedFrom,
                       boolean isMultiple, Optional<Integer> minItems, Optional<Integer> maxItems,
                       Optional<URI> propertyUri, Optional<URI> createdBy, Optional<URI> modifiedBy,
  ...
  @Override public ListField withExtensions(SchemaExtensions extensions) {
    return new ListFieldRecord(jsonLdContext, jsonLdTypes, jsonLdId, name, description, identifier, version,
