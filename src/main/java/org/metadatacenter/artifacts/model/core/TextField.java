...
{
  @Override TextField withExtensions(SchemaExtensions extensions);
...
record TextFieldRecord(LinkedHashMap<String, URI> jsonLdContext, List<URI> jsonLdTypes, Optional<URI> jsonLdId,
                       ...
                       String internalName, String internalDescription, SchemaExtensions extensions) implements TextField
{
  public TextFieldRecord(LinkedHashMap<String, URI> jsonLdContext, List<URI> jsonLdTypes, Optional<URI> jsonLdId,
                       String name, String description, Optional<String> identifier, Optional<Version> version,
                       Optional<Status> status, Optional<URI> previousVersion, Optional<URI> derivedFrom,
                       boolean isMultiple, Optional<Integer> minItems, Optional<Integer> maxItems,
                       Optional<URI> propertyUri, Optional<URI> createdBy, Optional<URI> modifiedBy,
  ...
  @Override public TextField withExtensions(SchemaExtensions extensions) {
    return new TextFieldRecord(jsonLdContext, jsonLdTypes, jsonLdId, name, description, identifier, version,
