...
public interface PageBreakFieldSchemaArtifact extends FieldSchemaArtifact
{
  static PageBreakFieldSchemaArtifact create(URI jsonSchemaSchemaUri, String jsonSchemaType, String jsonSchemaTitle,
  ...
  {
    return new PageBreakFieldSchemaArtifactRecord(jsonSchemaSchemaUri, jsonSchemaType, jsonSchemaTitle,
...
record PageBreakFieldSchemaArtifactRecord(URI jsonSchemaSchemaUri, String jsonSchemaType, String jsonSchemaTitle, String jsonSchemaDescription,
                                         ...
                                         Optional<OffsetDateTime> createdOn, Optional<OffsetDateTime> lastUpdatedOn,
                                          Optional<String> skosPrefLabel, List<String> skosAlternateLabels,
                                          FieldUi fieldUi, Optional<ValueConstraints> valueConstraints)
  implements PageBreakFieldSchemaArtifact
{
  public PageBreakFieldSchemaArtifactRecord
  {
