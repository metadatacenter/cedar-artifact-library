...
{
  @Override NumericField withExtensions(SchemaExtensions extensions);
...
{
  public NumericFieldRecord(LinkedHashMap<String, URI> jsonLdContext, List<URI> jsonLdTypes, Optional<URI> jsonLdId,
                          String name, String description, Optional<String> identifier, Optional<Version> version,
                          Optional<Status> status, Optional<URI> previousVersion, Optional<URI> derivedFrom,
                          boolean isMultiple, Optional<Integer> minItems, Optional<Integer> maxItems,
                          Optional<URI> propertyUri, Optional<URI> createdBy, Optional<URI> modifiedBy,
  ...
  @Override public NumericField withExtensions(SchemaExtensions extensions) {
    return new NumericFieldRecord(jsonLdContext, jsonLdTypes, jsonLdId, name, description, identifier, version,
