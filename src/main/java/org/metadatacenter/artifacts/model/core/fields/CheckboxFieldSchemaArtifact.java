...
public interface CheckboxFieldSchemaArtifact extends FieldSchemaArtifact
{
  static CheckboxFieldSchemaArtifact create(URI jsonSchemaSchemaUri, String jsonSchemaType, String jsonSchemaTitle,
  ...
  {
    return new CheckboxFieldSchemaArtifactRecord(jsonSchemaSchemaUri, jsonSchemaType, jsonSchemaTitle,
...
record CheckboxFieldSchemaArtifactRecord(URI jsonSchemaSchemaUri, String jsonSchemaType, String jsonSchemaTitle, String jsonSchemaDescription,
                                         ...
                                         Optional<String> skosPrefLabel, List<String> skosAlternateLabels,
                                         FieldUi fieldUi, Optional<ValueConstraints> valueConstraints)
  implements CheckboxFieldSchemaArtifact
{
  public CheckboxFieldSchemaArtifactRecord
  {
