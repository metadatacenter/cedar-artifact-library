...
{
  @Override RridField withExtensions(SchemaExtensions extensions);
      ...
      implements IriDefaultableFieldBuilder
  {
    ...
    public RridFieldBuilder(RridField rridField)
    {
      ...
      this.valueConstraintsBuilder = rridField.valueConstraints()
        .map(vc -> LinkValueConstraints.builder(vc.asLinkValueConstraints()))
        .orElseGet(LinkValueConstraints::builder);
    }

    @Override public RridFieldBuilder withRequiredValue(boolean requiredValue)
    {
...
record RridFieldRecord(LinkedHashMap<String, URI> jsonLdContext, List<URI> jsonLdTypes, Optional<URI> jsonLdId,
                       ...
                       String internalName, String internalDescription, SchemaExtensions extensions) implements RridField
{
  public RridFieldRecord(LinkedHashMap<String, URI> jsonLdContext, List<URI> jsonLdTypes, Optional<URI> jsonLdId,
                       String name, String description, Optional<String> identifier, Optional<Version> version,
                       Optional<Status> status, Optional<URI> previousVersion, Optional<URI> derivedFrom,
                       boolean isMultiple, Optional<Integer> minItems, Optional<Integer> maxItems,
                       Optional<URI> propertyUri, Optional<URI> createdBy, Optional<URI> modifiedBy,
  ...
  @Override public RridField withExtensions(SchemaExtensions extensions) {
    return new RridFieldRecord(jsonLdContext, jsonLdTypes, jsonLdId, name, description, identifier, version,
