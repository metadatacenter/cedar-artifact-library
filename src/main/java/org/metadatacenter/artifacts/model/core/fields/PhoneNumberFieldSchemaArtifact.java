...
public interface PhoneNumberFieldSchemaArtifact extends FieldSchemaArtifact
{
  static PhoneNumberFieldSchemaArtifact create(URI jsonSchemaSchemaUri, String jsonSchemaType, String jsonSchemaTitle,
  ...
  {
    return new PhoneNumberFieldSchemaArtifactRecord(jsonSchemaSchemaUri, jsonSchemaType, jsonSchemaTitle,
...
record PhoneNumberFieldSchemaArtifactRecord(URI jsonSchemaSchemaUri, String jsonSchemaType, String jsonSchemaTitle, String jsonSchemaDescription,
                                         ...
                                         Optional<OffsetDateTime> createdOn, Optional<OffsetDateTime> lastUpdatedOn,
                                            Optional<String> skosPrefLabel, List<String> skosAlternateLabels,
                                            FieldUi fieldUi, Optional<ValueConstraints> valueConstraints)
  implements PhoneNumberFieldSchemaArtifact
{
  public PhoneNumberFieldSchemaArtifactRecord
  {
