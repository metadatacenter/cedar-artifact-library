...
public interface TemporalFieldSchemaArtifact extends FieldSchemaArtifact
{
  static TemporalFieldSchemaArtifact create(URI jsonSchemaSchemaUri, String jsonSchemaType, String jsonSchemaTitle,
  ...
  {
    return new TemporalFieldSchemaArtifactRecord(jsonSchemaSchemaUri, jsonSchemaType, jsonSchemaTitle,
...
record TemporalFieldSchemaArtifactRecord(URI jsonSchemaSchemaUri, String jsonSchemaType, String jsonSchemaTitle, String jsonSchemaDescription,
                                         ...
                                         Optional<String> skosPrefLabel, List<String> skosAlternateLabels,
                                         FieldUi fieldUi, Optional<ValueConstraints> valueConstraints)
  implements TemporalFieldSchemaArtifact
{
  public TemporalFieldSchemaArtifactRecord
  {
