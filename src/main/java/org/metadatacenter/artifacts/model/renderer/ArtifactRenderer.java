...
public class ArtifactRenderer
{
  ...
  /**
   * Render a JSON Schema properties specification for a parent schema artifact. This specification defines
   * the JSON-LD @context field for parent artifacts. In addition to standard prefixes and fields, the @context
   * also contains property IRI mappings for every child field.
   * <p></p>
   * Defined as follows:
   * <pre>
   *   {
