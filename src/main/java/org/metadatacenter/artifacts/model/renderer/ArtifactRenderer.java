...
public class ArtifactRenderer
{
   ...
   *   "schema:name": "Disease",
   *   "schema:description": "Please enter a disease",
   *   "description": "Disease field schema generated by the CEDAR Template Editor 2.6.19",
   *   "schema:schemaVersion": "1.6.0",
   *   "schema:identifier": "id5666",
   *   "pav:version": "0.0.1",
   *   "bibo:status": "bibo:draft",
